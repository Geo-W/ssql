...
use crate::{FilterExpr, QueryBuilder, SsqlMarker, SsqlResult};
...
impl<'a, Ta> QueryBuilder<'a, Ta, NormalQuery>
where
...
#[async_trait]
impl<'a, Ta> QueryAble<'a> for QueryBuilder<'a, Ta, NormalQuery>
where
    Ta: SsqlMarker + Send + Sync,
    // QueryBuilder<'a, Ta, NormalQuery>: Send + Executable,
{
