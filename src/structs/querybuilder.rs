...
#[async_trait]
impl<'a, T> Executable for QueryCore<'a, T, NormalQuery>
where
...
#[async_trait]
impl<'a, Ta> Executable for QueryCore<'a, Ta, RawQuery>
where
...
pub struct QueryCore<'a, T: SsqlMarker, Stage = NormalQuery> {
...
impl<'a, T, Stage: 'static> QueryCore<'a, T, Stage>
where
    T: SsqlMarker + 'static,
    QueryCore<'a, T, Stage>: Executable,
{
...
impl<'a, T> QueryCore<'a, T, NormalQuery>
where
    T: SsqlMarker,
{
    #[doc(hidden)]
